...
},{"process":"../../node_modules/process/browser.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = exports.displayMap = function displayMap() {
  mapboxgl.accessToken = "pk.eyJ1Ijoic2hhcmswMTAiLCJhIjoiY2xqbmJsamRtMGFnODNrcW1nc2Y3MmEwYSJ9.9AT5bFTv5aI4kqLI4mn8TQ";
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error logging out! check your internet connection and try again.');
        case 10:
        case "end":
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var changeSettings = exports.changeSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " saved successfully"));
          _context.next = 10;
          break;
        case 7:
          _context.prev = 7;
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(propertyId) {
    var stripe, session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _stripeJs.loadStripe)('pk_test_51NQgLnAMjq2DeMy9mzc7CJhqEvRPVucYCwtXVhUoBkS6J7ppwY5jtObApiWNFB2NJ5zJmoIWBk07W7jX7MihGgR600mSRIrubK');
        case 2:
          stripe = _context.sent;
          _context.prev = 3;
          _context.next = 6;
          return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(propertyId));
        case 6:
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/dist/stripe.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var bookBtn = document.getElementById("book-property");
// DELEGATION
if (mapBox) {
...
(0, _jquery.default)(document).ready(function () {
  if (bookBtn) {
    bookBtn.addEventListener("click", function (e) {
      ...
      var propertyId = e.target.dataset.propertyId;
      (0, _stripe.bookTour)(propertyId);
    });
  }
  (0, _jquery.default)("#filterToggle").on("click", function () {
    // Toggle the arrow-down class to arrow-up
    (0, _jquery.default)(this).toggleClass("arrow-down arrow-up");
    (0, _jquery.default)("#filterForm").slideToggle();
  });
});
// index.js

// index.js
var lessThan100kPercentage = parseFloat(document.getElementById("lessThan100kPercentage").innerText);
var between100kAnd500kPercentage = parseFloat(document.getElementById("between100kAnd500kPercentage").innerText);
var moreThan500kPercentage = parseFloat(document.getElementById("moreThan500kPercentage").innerText);
(function () {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var chartData = {
      ...
      datasets: [{
        data: [lessThan100kPercentage, between100kAnd500kPercentage, moreThan500kPercentage],
...
if (userDataForm) {
  document.querySelector(".form").addEventListener("submit", function (e) {
    ...
    (0, _updateSettings.changeSettings)(form, "data");
  });
}
if (userPasswordForm) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateSettings.changeSettings)({
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11055" + '/');
